  ...
  <div className="container-fluid ">
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav me-auto mb-2">
        ...
        <li className="nav-item">
          <Link className="nav-link fs-5" aria-current="page" to="/contact">Contact Us</Link>
        </li>
        <li className="nav-item">
        ...
        <div class="nav-item dropdown">
          ...
          <Link class="dropdown-item" to="/login">User signup</Link>
    <Link class="dropdown-item" to="/login">Company signup</Link>  
          </div>
        </div>
    <div class="nav-item dropdown mx-3 float-right">
          ...
          <Link class="dropdown-item" to="/login">Company login</Link>  
          <Link class="dropdown-item" to="/login">Admin login</Link>  
          </div>
        </div>
