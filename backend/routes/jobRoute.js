...
const { getAllJobs,createjob, updateJob, deleteJob, getJobDetails, getAdminJobss, getAdminJobs, getCompanyJobs } = require("../controllers/jobController");
...
router.route("/company/jobs").get(isAuthenticatedUser,getCompanyJobs);
router.route("/admin/jobs").get(isAuthenticatedUser,getAdminJobs);
